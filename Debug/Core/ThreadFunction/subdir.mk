...
C_SRCS += \
../Core/ThreadFunction/ThreadFunction.c 

OBJS += \
./Core/ThreadFunction/ThreadFunction.o 

C_DEPS += \
./Core/ThreadFunction/ThreadFunction.d 


# Each subdirectory must supply rules for building sources it contributes
Core/ThreadFunction/%.o Core/ThreadFunction/%.su Core/ThreadFunction/%.cyclo: ../Core/ThreadFunction/%.c Core/ThreadFunction/subdir.mk
...
clean: clean-Core-2f-ThreadFunction

clean-Core-2f-ThreadFunction:
	-$(RM) ./Core/ThreadFunction/ThreadFunction.cyclo ./Core/ThreadFunction/ThreadFunction.d ./Core/ThreadFunction/ThreadFunction.o ./Core/ThreadFunction/ThreadFunction.su

.PHONY: clean-Core-2f-ThreadFunction
