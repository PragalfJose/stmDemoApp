...
C_SRCS += \
../Core/BlinkTask/BlinkTask.c 

OBJS += \
./Core/BlinkTask/BlinkTask.o 

C_DEPS += \
./Core/BlinkTask/BlinkTask.d 


# Each subdirectory must supply rules for building sources it contributes
Core/BlinkTask/%.o Core/BlinkTask/%.su Core/BlinkTask/%.cyclo: ../Core/BlinkTask/%.c Core/BlinkTask/subdir.mk
...
clean: clean-Core-2f-BlinkTask

clean-Core-2f-BlinkTask:
	-$(RM) ./Core/BlinkTask/BlinkTask.cyclo ./Core/BlinkTask/BlinkTask.d ./Core/BlinkTask/BlinkTask.o ./Core/BlinkTask/BlinkTask.su

.PHONY: clean-Core-2f-BlinkTask
