...
Core/Console/%.o Core/Console/%.su Core/Console/%.cyclo: ../Core/Console/%.c Core/Console/subdir.mk
...
clean-Core-2f-Console:
	-$(RM) ./Core/Console/Console.cyclo ./Core/Console/Console.d ./Core/Console/Console.o ./Core/Console/Console.su
