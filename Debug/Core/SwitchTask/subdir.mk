...
C_SRCS += \
../Core/SwitchTask/SwitchTask.c 

OBJS += \
./Core/SwitchTask/SwitchTask.o 

C_DEPS += \
./Core/SwitchTask/SwitchTask.d 


# Each subdirectory must supply rules for building sources it contributes
Core/SwitchTask/%.o Core/SwitchTask/%.su Core/SwitchTask/%.cyclo: ../Core/SwitchTask/%.c Core/SwitchTask/subdir.mk
...
clean: clean-Core-2f-SwitchTask

clean-Core-2f-SwitchTask:
	-$(RM) ./Core/SwitchTask/SwitchTask.cyclo ./Core/SwitchTask/SwitchTask.d ./Core/SwitchTask/SwitchTask.o ./Core/SwitchTask/SwitchTask.su

.PHONY: clean-Core-2f-SwitchTask
