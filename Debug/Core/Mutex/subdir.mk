...
Core/Mutex/%.o Core/Mutex/%.su Core/Mutex/%.cyclo: ../Core/Mutex/%.c Core/Mutex/subdir.mk
...
clean: clean-Core-2f-Mutex

clean-Core-2f-Mutex:
	-$(RM) ./Core/Mutex/Mutex.cyclo ./Core/Mutex/Mutex.d ./Core/Mutex/Mutex.o ./Core/Mutex/Mutex.su

.PHONY: clean-Core-2f-Mutex
